...
[`@aws-sdk/client-rds-data`](https://www.npmjs.com/package/@aws-sdk/client-rds-data/v/3.1058.0).
...
- @aws-sdk/client-rds-data v3.1058.0 - [https://cloud-sdk-builds.github.io/?sdk=client-rds-data&version=3.1058.0](https://cloud-sdk-builds.github.io/?sdk=client-rds-data&version=3.1058.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rds-data@3.1058.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AHOgKRp3glnnbVALbjrOQL5H7aVOlemPCLWTo1u0f8UetdNtEkQrNrKeSgXLSXI4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-rds-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rds-data@3.1058.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rds-data@3.1058.0/index.min.mjs": "sha384-AHOgKRp3glnnbVALbjrOQL5H7aVOlemPCLWTo1u0f8UetdNtEkQrNrKeSgXLSXI4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-rds-data/blob/refs/tags/3.1058.0/LICENSE
```
