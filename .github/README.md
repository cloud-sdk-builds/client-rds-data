...
[`@aws-sdk/client-rds-data`](https://www.npmjs.com/package/@aws-sdk/client-rds-data/v/3.1050.0).
...
- @aws-sdk/client-rds-data v3.1050.0 - [https://cloud-sdk-builds.github.io/?sdk=client-rds-data&version=3.1050.0](https://cloud-sdk-builds.github.io/?sdk=client-rds-data&version=3.1050.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rds-data@3.1050.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZJKQtmcnCwX6jgVIL5/7z7DyKId8s5t3qM5ZH8pJaSwD258WePUKVWGY1SMAVFn2
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-rds-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rds-data@3.1050.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rds-data@3.1050.0/index.min.mjs": "sha384-ZJKQtmcnCwX6jgVIL5/7z7DyKId8s5t3qM5ZH8pJaSwD258WePUKVWGY1SMAVFn2"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-rds-data/blob/refs/tags/3.1050.0/LICENSE
```
