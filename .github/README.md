...
[`@aws-sdk/client-rds-data`](https://www.npmjs.com/package/@aws-sdk/client-rds-data/v/3.846.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rds-data@3.846.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bbB7TDgWv+2R7sh5QSjy5aWsyez0sJEz3lsjF1LJMZYvoEGEHqs3TCbbkeKSAhzx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-rds-data": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rds-data@3.846.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-rds-data@3.846.0/index.min.mjs": "sha384-bbB7TDgWv+2R7sh5QSjy5aWsyez0sJEz3lsjF1LJMZYvoEGEHqs3TCbbkeKSAhzx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-rds-data/blob/refs/tags/3.846.0/LICENSE
```
